...
from my_reaver.envs.base import Spec
from my_reaver.agents.base import MemoryAgent
from my_reaver.utils import Logger
from my_reaver.utils.tensorflow import SessionManager
from my_reaver.utils.typing import ModelBuilder, PolicyType
...
class SupervisedBaseAgent(MemoryAgent):
    """
