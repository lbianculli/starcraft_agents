# COPY THIS SOMEWHERE BEFORE RUNNING
...
class TerranAgent(base_agent.BaseAgent):
    def __init__(self, # which init does this stuff go into?
        ...
        super(TerranAgent, self).__init__(self)
...
#         self.act_x_wrapped, self.act_y_wrapped = self._setup_learn() # setup here i think, how exactly?
...
#         self.replay_buffer_y.add(screen, action_y, step_reward, new_screen, float(done))
    ...
    def _setup_learn(self, num_actions): # how to determine? len(available_actions) prob. should prob be somewhere else
        '''
        ...
        self.sess = U.make_session(self.num_cpu)
        self.sess.__enter__()
