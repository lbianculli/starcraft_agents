...
flags.DEFINE_bool("continuation", False, "Continue from save. For training or testing.")
...
flags.DEFINE_integer('snapshot_step', int(1e3), 'steps between snapshots.')
            ...
            with sc2_env.SC2Env(
                ...
                for recorder, is_done in run_loop([agent], env, MAX_AGENT_STEPS):
                  if FLAGS.training:
                    ...
                    print('Your score is '+str(score)+'!')  # does this ever print?
...
def main(unused_argv):
  ...
  if FLAGS.continuation and os.path.exists(SNAPSHOT):  # should the training flag be here 
    global COUNTER
